...
let {validateSignUpRequest,validateLoginRequest,validateChangePasswordRequest,validateRequest} = require('../utils/validator')

router.post('/signup',validateSignUpRequest,validateRequest, async function (req, res, next) {
        try {
...
router.post('/login',validateLoginRequest,validateRequest, async function (req, res, next) {
    try {
...
router.post('/change_password', check_authentication, validateChangePasswordRequest, validateRequest,
